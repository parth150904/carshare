...
// for deleting user
  ...
  {
  $delid=$_GET['id'];
  $msg=mysqli_query($con,"delete from car_ride where r_id='$delid'");
  if($msg)
  {
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Added Ride</h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Added Ride Details </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Ride id</th>
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($con,"SELECT * FROM `car_ride` ");
							  $cnt=1;
							  while($row=mysqli_fetch_array($ret))
							  {?>
                              <tr>
                              <td><?php echo $row['r_id'];?></td>
                                  <td><?php echo user_name($row['owner']);?><br>User ID : <?php echo $row['owner'];?></td>
                                  <td><?php echo $row['city'];?></td>
                                  <td><?php echo $row['r_from'];?></td>
                                  <td><?php echo $row['r_via'];?></td>  
                                  <td><?php echo $row['r_to'];?></td>
                                  ...
                                  <td>
                                     ...
                                     <a href="car_ride.php?id=<?php echo $row['r_id'];?>"> 
